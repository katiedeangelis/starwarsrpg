...
$(window).load(function () {
    ...
    var skywalker = new StarWarsChar("Luke Skywalker", "assets/images/skywalker.png", 150, 6, 6);
    var darth = new StarWarsChar("Darth Vader", "assets/images/darthvader.png", 210, 10, 20);
    var leia = new StarWarsChar("Princess Leia", "assets/images/leia.png", 170, 8, 16);
    var jabba = new StarWarsChar("Jabba the Hutt", "assets/images/jabba.png", 110, 1, 3);

    var characterOptions = [skywalker, darth, leia, jabba];

    jQuery.each(characterOptions, function (i, val) {
        console.log(val);
        var newCharDiv = $("<div class='char-tile'>");
...
function StarWarsChar(name, image, health, attack, counter) {
    this.name = name;
    this.image = image;
    this.health = health;
    this.attack = attack;
